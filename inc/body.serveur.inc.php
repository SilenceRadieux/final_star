        ...
        <li class="tous <?= $team['role_team'] ?>">
          ...
          <?php foreach ($medias as $media) { ?>
            <?php if (empty($media['lien'])): ?>
              <div class="team-avatar team-avatar-img">
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    var images = document.querySelectorAll('.team-avatar-img');
    var teamLink = document.getElementsByClassName('team-link');
